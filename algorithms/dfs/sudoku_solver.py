...
Each time, start from the location with the fewest possible values, choose one value
...
location with the fewest possible values, the amount of calculation and thus the
